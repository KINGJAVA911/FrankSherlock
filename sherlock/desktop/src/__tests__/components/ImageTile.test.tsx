...
describe("ImageTile", () => {
  it("renders the file name", () => {
    render(
      <ImageTile item={mockItem} index={0} isSelected={false} isFocused={false} onClick={() => {}} onDoubleClick={() => {}} />
    );
  ...
  it("renders placeholder when no thumbnail", () => {
    ...
    const { container } = render(
      <ImageTile item={noThumb} index={0} isSelected={false} isFocused={false} onClick={() => {}} onDoubleClick={() => {}} />
    );
  ...
  it("applies selected class", () => {
    const { container } = render(
      <ImageTile item={mockItem} index={0} isSelected={true} isFocused={false} onClick={() => {}} onDoubleClick={() => {}} />
    );
  ...
  it("calls onClick with index and event", async () => {
    ...
    const onClick = vi.fn();
    render(
      <ImageTile item={mockItem} index={3} isSelected={false} isFocused={false} onClick={onClick} onDoubleClick={() => {}} />
    );
  ...
  it("calls onDoubleClick with index", async () => {
    ...
    render(
      <ImageTile item={mockItem} index={2} isSelected={false} isFocused={false} onClick={() => {}} onDoubleClick={onDoubleClick} />
    );
